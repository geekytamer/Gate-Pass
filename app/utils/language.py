...
TRANSLATIONS = {
    "en": {
        ...
        "request_sent_relative": "✅ Your exit request with a relative has been submitted. Waiting for your parent’s approval.",
        "bus_confirmed": "✅ Your exit request by bus has been confirmed.",
        "otp_sent": "📨 An approval message with a code has been sent to your parent.",
    ...
    "ar": {
        ...
        "request_sent_relative": "✅ تم إرسال طلب الخروج مع قريب. في انتظار موافقة ولي الأمر.",
        "bus_confirmed": "✅ تم تأكيد طلب الخروج بالحافلة.",
        "otp_sent": "📨 تم إرسال رسالة موافقة تحتوي على رمز إلى ولي أمرك.",
